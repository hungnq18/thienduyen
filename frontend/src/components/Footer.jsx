      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-6">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <div className="space-y-2 text-lg" style={{ fontFamily: "Arimo, sans-serif", fontWeight: 400 }}>
            ...
            <p>
              Email:{" "}
              <Link to="/contact" className="hover:text-[#E8C585] transition-colors underline">
                Thienduyenceremony@gmail.com
              </Link>
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <div className="flex gap-4 justify-center md:justify-start">
            ...
            <button
              onClick={() =>
                window.open(
                  "https://www.tiktok.com/@_thienduyenwedding_?_r=1&_t=ZS-91M5ThtiVsG",
                  "_blank"
                )
              }
              className="w-[42px] h-[42px] hover:scale-110 transition-transform"
            ...
            {/* Google/Mail */}
            <Link to="/contact" className="w-[42px] h-[42px] hover:scale-110 transition-transform inline-block">
