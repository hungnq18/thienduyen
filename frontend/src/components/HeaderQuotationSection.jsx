    ...
    <div className="min-h-screen ">
            ...
            {services.map((service) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <button className="mt-6 w-full bg-red-900 px-4 py-3 text-center text-sm font-semibold text-white transition-colors duration-200 hover:bg-red-800">
                    {service.description}
                  </button>
                </div>
              </div>
      ...
      <div className="flex justify-center pb-16">
        <button
          ...
          className="flex h-16 w-16 items-center justify-center rounded-full  hover:bg-red-100 focus:outline-none"
