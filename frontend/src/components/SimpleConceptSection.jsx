...
const SimpleConceptSection = () => {
  const navigate = useNavigate();
    const includedItems = [
      {
        title: 'Cổng chùa / lối vào:cổng tre, lá trúc, bảng gỗ khắc tên lễ. ',
        description: 'Trang trí với hoa sen, đèn lồng đỏ-vàng',
      },
      {
        title: 'Đường dẫn vào chánh điện:',
        description: 'lối đi trải chiếu cói hoặc thảm màu be, hai bên cắm hoa trắng, lá xanh.',
      },
      {
        title: 'Chánh điện (bàn lễ Phật): lọ gốm sứ, hoa trắng, nến hoặc đèn dầu nhỏ.',
        description: 'Đặt trước sân chùa, phủ vải gấm, trang trí bình hoa sen',
      },
      {
        title: 'Bàn nghi lễ của đôi uyên ương: ',
        description: 'bàn gỗ mộc, phủ khăn vải bố trắng kem, điểm hoa sen hoặc hoa ly trắng.',
      },
      {
        title: 'Ghế ngồi/ khu vực khách:',
        description: 'ghế gỗ hoặc ghế trắng, trang trí tối giản với dây ruy băng màu nâu nhạt.',
      },
      {
        title: 'Backdrop chụp hình:',
        description: 'vách tre, vòng hoa lá xanh, chữ calligraphy tối giản (VD: “Hằng Thuận Ceremony”).',
      }
    ];
            ...
            <div className="relative w-full h-[400px] md:h-[600px] rounded-lg overflow-hidden shadow-lg">
              ...
              >
                ...
                >
                  ...
                  <span style={{ whiteSpace: 'nowrap', display: 'block' }}>THIỀN-TỐI GIẢN</span>
                </h2>
              </div>
            </div>
          </div>
          ...
          <div className="text-left">
            ...
            <div className="rounded-b-lg">
              <p 
                ...
                style={{ fontFamily: "'Arima Madurai', sans-serif" }}
              >
                Là gói dịch vụ được lấy cảm hứng từ tinh thần Thiền trong Phật giáo, hướng đến sự cân bằng và bình yên trong từng chi tiết.
              </p>
              <p 
                className="text-base md:text-lg lg:text-xl text-gray-800"
                style={{ fontFamily: "'Arima Madurai', sans-serif" }}
              >
                 Không chỉ là trang trí, mà là nghệ thuật chạm đến sự tĩnh lặng, nơi không gian giản dị, ánh sáng tự nhiên và sắc hoa thanh khiết hòa quyện cùng hơi thở thiền vị – tạo nên một buổi lễ Hằng Thuận an hòa và sâu lắng.
              </p>
            </div>
          </div>
